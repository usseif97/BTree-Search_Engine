...
public class UnitTest {
	...
	public void testDeletionComplex1() {
		...
		try {
		    ...
		    /*Assert.assertTrue(btree.delete(19));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(10));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(11));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(20));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());*/
			...
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(17));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(6));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(24));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(11));
			if (btree.getRoot() != null)
			...
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(18));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(21));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(20));
			if (btree.getRoot() != null)
			...
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(25));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(13));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(15));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(22));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(26));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			...
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(1));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(3));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(5));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(12));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			Assert.assertTrue(btree.delete(14));
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
			if (btree.getRoot() != null)
				verifyBTree(btree.getRoot(), 0, getHeight(btree.getRoot()), 3, btree.getRoot());
